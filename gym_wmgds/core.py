...
from gym_wmgds.utils import closer
...
class Env(object):
    """The main OpenAI gym_wmgds class. It encapsulates an environment with
    ...
    def unwrapped(self):
        ...
        Returns:
            gym_wmgds.Env: The base non-wrapped gym_wmgds.Env instance
        """
        return self
...
class GoalEnv(Env):
    """A goal-based environment. It functions just as any regular OpenAI gym_wmgds environment but it
