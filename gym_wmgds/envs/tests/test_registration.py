# -*- coding: utf-8 -*-
import gym_wmgds
from gym_wmgds import error, envs
from gym_wmgds.envs import registration
from gym_wmgds.envs.classic_control import cartpole

class ArgumentEnv(gym_wmgds.Env):
...
gym_wmgds.register(
    ...
    entry_point='gym_wmgds.envs.tests.test_registration:ArgumentEnv',
    kwargs={
        'arg1': 'arg1',
        'arg2': 'arg2',
    }
