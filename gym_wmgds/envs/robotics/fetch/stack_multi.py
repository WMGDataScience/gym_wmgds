...
MODEL_XML_PATH_BORDER = os.path.join('fetch', 'stack_multi_borders.xml')


class FetchStackMultiEnv(fetch_multi_env.FetchMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15, change_stack_order=False):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
        ...
        fetch_multi_env.FetchMultiEnv.__init__(
            ...
            change_stack_order=change_stack_order)
        utils.EzPickle.__init__(self)


class FetchStackBordersMultiEnv(fetch_multi_env.FetchMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15, change_stack_order=False):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        fetch_multi_env.FetchMultiEnv.__init__(
            self, MODEL_XML_PATH_BORDER, block_gripper=False, n_substeps=20,
            gripper_extra_height=0.2, target_in_the_air=False, target_stacked=True, target_offset=0.0,
            obj_range=obj_range, target_range=0.15, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type, 
            n_objects=n_objects, obj_action_type=obj_action_type, observe_obj_grp=observe_obj_grp,
