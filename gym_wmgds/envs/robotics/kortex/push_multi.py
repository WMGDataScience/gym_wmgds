...
from gym_wmgds.envs.robotics import kortex_multi_env
...
MODEL_XML_PATH = os.path.join('kortex', 'push_multi.xml')

class KortexPushMultiEnv(kortex_multi_env.KortexMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.30):
        ...
        kortex_multi_env.KortexMultiEnv.__init__(
