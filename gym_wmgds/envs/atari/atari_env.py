...
try:
    ...
    raise error.DependencyNotInstalled("{}. (HINT: you can install Atari dependencies by running 'pip install gym_wmgds[atari]'.)".format(e))
...
class AtariEnv(gym_wmgds.Env, utils.EzPickle):
