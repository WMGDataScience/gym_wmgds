...
def play(env, transpose=True, fps=30, zoom=None, callback=None, keys_to_action=None):
    ...
    gym_wmgds.utils.play.PlayPlot. Here's a sample code for plotting the reward
    ...
    assert type(obs_s) == gym_wmgds.spaces.box.Box
